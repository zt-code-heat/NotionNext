const CONFIG = {
  ...
  // 英雄区右侧推荐文章标签, 例如 [推荐] , 最多一篇文章; 若留空白''，则推荐最近更新文章
  HEO_HERO_RECOMMEND_POST_TAG: '推荐',
  HEO_HERO_RECOMMEND_POST_COUNT: 1, // 只显示1篇推荐
  HEO_HERO_RECOMMEND_COVER_SCALE: 1.4, // 放大图片
  HEO_HERO_RECOMMEND_POST_SORT_BY_UPDATE_TIME: false, // 推荐文章排序，为`true`时将强制按最后修改时间倒序
     //HERO_RECOMMEND_COVER: '/images/heo/8015c16f210710fd996da7dec3d9a0a7.jpg', // 英雄区右侧图片
